...
import { motion } from "framer-motion";
import { Link } from "react-router-dom";
import { Sparkles, UserCog, ArrowUpRight } from "lucide-react";

const AdminWelcome = () => {
  return (
    <div className="min-h-screen bg-[#EEEEEE] text-[#473472] font-sans overflow-hidden relative">
      
      {/* FIX 1: Added 'z-50' to bring this to the very front.
          Removed the extra wrapping <div> and put the onClick on the Link container if needed, 
          though usually Link doesn't need an onClick for logging.
      */}
      <div className="absolute top-6 right-6 z-50">
        <Link to="/logout">
          <motion.button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-[#53629E] text-white rounded-2xl shadow-lg hover:shadow-xl transition-all cursor-pointer font-semibold"
          >
            Logout
            <ArrowUpRight size={18} />
          </motion.button>
      ...
      {/* FIX 2: Added 'pointer-events-none' so clicks pass through this background layer 
      */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 min-h-screen">
        ...
        >
          <Link
            to="/proposalsreview"
            className="flex items-center gap-3 px-8 py-4 rounded-2xl hover:scale-[1.15]
            border hover:shadow-lg hover:border-[#473472] duration-300
            bg-gradient-to-r from-[#53629E] to-[#473472] 
            text-white font-bold
            shadow-2xl shadow-[#473472]/40 hover:shadow-[#473472]/60 transition-all"
          >
